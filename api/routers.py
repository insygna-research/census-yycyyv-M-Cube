...
_OA_STUBS = {'oa_parser': {'defects': [{'defect_type': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                            'rejected_claims': [1],
                            'main_cited_docs': ['D1', 'D2'],
                            'feature_mappings': [{'target_feature': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'prior_art_doc': 'D1',
                                                  'cited_paragraphs': '[0032]',
                                                  'cited_figures': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'examiner_logic': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                            'combination_motivation': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
               'overall_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'multimodal_prior_art': {'supporting_items': [{'target_feature': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'prior_art_text_disclosure': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'prior_art_visual_disclosure': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'amendment_avoidance_warning': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                          'disputable_items': [{'target_feature': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'examiner_assertion': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'multimodal_reality_check': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'rebuttal_angle': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                          'examiner_conclusion_supported': True,
                          'confidence': 'High',
                          'overall_conclusion': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'application_baseline': {'claims_tree': [{'claim_number': 1,
                                          ...
                                          {'claim_number': 2,
                                           ...
                                           'features': [{'feature_id': '2A',
                                                         'feature_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}]}],
                          'spec_feature_index': [{'component_or_step_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'reference_numeral': '10',
                                                  'detailed_description': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'alternative_embodiments': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'source_paragraph': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
                                                 {'component_or_step_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'reference_numeral': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'detailed_description': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'alternative_embodiments': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                  'source_paragraph': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                          'claim_tree_overview': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                          'normalized_claim_features': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                          'fallback_features': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                          'specification_feature_index': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。']},
 'concession_gap': {'overall_strategy_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                    ...
                    'mining_directives': [{'target_component_or_step': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                           'technical_gap_to_fill': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                           'avoidance_warning': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                    'failed_claims': [1],
                    'confirmed_points': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                    'gap_targets': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                    'rationale': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'fallback_feature_mining': {'mining_status': 'SUCCESS',
                             'candidates': [{'candidate_id': 'Candidate_A',
                                             'addressed_directive': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'reference_numeral': '15',
                                             'verbatim_quote': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'source_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'gap_filling_rationale': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
                                            ...
                                            {'candidate_id': 'Candidate_C',
                                             ...
                                             'source_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'gap_filling_rationale': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                             'mining_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'prior_art_stress_test': {'overall_survival_rate': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                           'tested_features': [{'candidate_id': 'Candidate_A',
                                                'feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'test_verdict': 'ELIMINATED',
                                                'prior_art_hit_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'red_team_reasoning': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'rebuttal_foundation': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
                                               {'candidate_id': 'Candidate_B',
                                                'feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'test_verdict': 'ELIMINATED',
                                                'prior_art_hit_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                           ...
                           'summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'strategy_decision': {'global_decision': 'AMEND_AND_ARGUE',
                       'strategy_rationale': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                       'amendment_plan': {'target_independent_claim': 1,
                                          'amendment_tactic': 'INTRODUCE_SPEC_FEATURE',
                                          'source_dependent_claims': [],
                                          'survived_candidate_ids': ['Candidate_C'],
                                          'amendment_guidance': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
                       'rebuttal_plan': [{'target_claim': 1,
                                          'core_argument_logic': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                          'evidence_support': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                       'action': 'AMEND_AND_ARGUE',
                       'amendment_instruction': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                       'argument_logic': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                       'selected_candidate_ids': ['Candidate_C']},
 'claim_amendment': {'is_amended': True,
                     'amendment_basis_statement': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'claim_mappings': [{'original_claim_number': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                         'new_claim_number': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                         'amendment_type': 'MODIFIED_WITH_NEW_FEATURE',
                                         'amended_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                     'final_claims_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'amended_claims': {'claims': [{'id': 1, 'text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}]},
                     'amendment_log': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。']},
 'argument_writer': {'amendment_statement': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'arguments_by_claim': [{'target_claim': 1,
                                             'closest_prior_art': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'distinguishing_features': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'technical_problem_solved': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'non_obviousness_logic': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                             'legal_conclusion': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                     'final_reply_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'argument_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'key_points': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。']},
 'spec_update': {'requires_spec_update': True,
                 'amendment_items': [{'target_paragraph': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                      'original_text_snippet': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                      'amended_text_snippet': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                      'amendment_reason': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                 'article_33_declaration': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                 'applied': True,
                 'changes': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                 'updated_excerpt': ''},
 'response_traceability': {'global_go_no_go': 'GO',
                           'support_basis_audit': [{'severity': 'PASS',
                                                    'risk_category': 'A26.4_UNSUPPORTED',
                                                    'problematic_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                    'audit_reasoning': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                    'suggested_remedy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                           ...
                           'harmful_admission_audit': [{'severity': 'WARNING',
                                                        ...
                                                        'audit_reasoning': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                        'suggested_remedy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                           'final_strategy_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                           'claim_support_ok': True,
                           'logic_consistency_ok': True,
                           'findings': [],
                           'final_risk_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}}
_COMPARE_STUBS = {'draft_parser': {'claims_tree': [{'claim_number': 1,
                                   'is_independent': True,
                                   'dependency': [],
                                   'atomic_features': [{'feature_id': 'F1.1',
                                                        'verbatim_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                        'entity_components': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                                                        'connection_and_synergy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                        'visual_anchor': {'reference_numeral': '10',
                                                                          'figure_labels': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                                                                          'visual_morphology': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}},
                                                       {'feature_id': 'F1.2',
                                                        'verbatim_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                        'entity_components': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                                                        'connection_and_synergy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                        'visual_anchor': {'reference_numeral': '20',
                                                                          'figure_labels': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                                            '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                                                                          'visual_morphology': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}}]}],
                  'fallback_feature_index': [{'feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                              'verbatim_quote': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                              'connection_and_synergy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                              'source_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                              'visual_anchor': {'reference_numeral': '10',
 ...
 'prior_art_parser': {'comparison_goal': 'patentability',
                      'prior_art_profiles': [{'prior_art_id': 'D1',
                                              'core_technical_problem_solved': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                              'component_index': [{'component_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                   'reference_numeral': '10',
                                                                   'structural_connections_and_mechanisms': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                   'visual_appearance': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                                              'figure_library': [{'figure_label': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                  'observed_components': ['10',
                                                                                          '20'],
                                                                  'visual_connections': [{'source_component': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                                          'target_component': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                                          'kinematic_relationship': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}]}],
                                              'reading_audit': {'input_image_count': 6,
                                                                'actually_used_image_count': 5,
                                                                'omission_warning': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}}],
                      'overall_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'matrix_comparison': {'global_conclusion': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                       'prior_art_targeted_report': [{'claim_number': 1,
                                                      'feature_collisions': [{'feature_id': 'F1.1',
                                                                              'prior_art_id': 'D1',
                                                                              'text_evidence': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                              'visual_evidence': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                              'component_match_status': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                              'relationship_match_status': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                              'disclosure_status': 'EXPLICIT',
                                                                              'collision_reasoning': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
                                                                             {'feature_id': 'F1.2',
                                                                              'prior_art_id': 'D1',
                                                                              'text_evidence': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                                              'visual_evidence': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
 ...
 'risk_assessment': {'global_risk_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'claim_assessments': [{'claim_number': 1,
                                            'novelty_risk': 'FATAL',
                                            'inventiveness_risk': 'HIGH',
                                            'topology_difference_analysis': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'breakthrough_point': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'robust_distinguishing_features': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。']}],
                     'strategic_amendment_direction': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'amendment_suggestion': {'overall_rescue_strategy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                          'concrete_amendments': [{'target_claim_number': 1,
                                                   'amendment_type': 'INTRODUCE_SPEC_FEATURE',
                                                   'source_feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'source_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'verbatim_addition': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'synergy_and_mechanism_focus': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'draft_amended_claim_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'expected_overcoming_effect': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                          'article_33_compliance_statement': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}}
_POLISH_STUBS = {'diagnostic_analyzer': {'overview': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                         'wide_scope_issues': [{'issue_type': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'severity': 'high',
                                                'claim_scope': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'evidence': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'recommendation': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                         'dependent_gap_issues': [{'issue_type': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'severity': 'medium',
                                                   'claim_scope': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'evidence': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                   'recommendation': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                         'effect_gap_issues': [{'issue_type': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'severity': 'medium',
                                                'claim_scope': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'evidence': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                                'recommendation': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}],
                         'key_repair_targets': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。']},
 'synergy_miner': {'vault_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                   'high_value_features': [{'feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'source_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'verbatim_quote': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'connection_and_synergy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'value_score': 'high',
                                            'recommended_usage': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
                                           {'feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'source_location': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'verbatim_quote': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'connection_and_synergy': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                            'value_score': 'medium',
                                            'recommended_usage': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'}]},
 'claim_architect': {'architecture_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'rebuilt_claims': [{'claim_number': 1,
                                         'claim_type': 'independent',
                                         'depends_on': [],
                                         'draft_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                         'added_mechanisms': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                                         'source_basis': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。']},
                                        {'claim_number': 2,
                                         'claim_type': 'dependent',
                                         'depends_on': [1],
                                         'draft_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                                         'added_mechanisms': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'],
                                         'source_basis': ['占位说明文本用于测试流程稳定运行并满足字段最小长度要求。', '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。']}],
                     'optimized_claims_text': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                     'article_33_basis': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。'},
 'specification_amplifier': {'amplification_summary': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
                             'mechanism_effect_map': [{'feature_name': '占位说明文本用于测试流程稳定运行并满足字段最小长度要求。',
